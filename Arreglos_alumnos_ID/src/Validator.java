...
public class Validator {
    //Validar el id
    public int Id(String message, Scanner sc, Alumnos[] alumnos, int contador){
        int id;
        while(true){
    ...
    public double Promedio(String message, Scanner sc,  int min, int max){
        double promedio = -1;
        do {
        ...
        } while (promedio < min || promedio > max);
